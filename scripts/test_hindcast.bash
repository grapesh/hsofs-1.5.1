...
export pythonCode=${platform}"/gpfs/hps3/nos/noscrub/nwprod/hsofs-1.5.1/hsofs/post_hindcast.py"
...
export stormCycle="2018101100" #$1
...
#export ftpPath="/home/www/polar/estofs/hsofs/"${stormID}"."${stormCycle}.hindcast
export ftpPath="/home/www/polar/estofs/hsofs/"${stormID}".2018101200.hindcast"
