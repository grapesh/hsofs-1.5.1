...
export hsofsDir=${platform}"/gpfs/hps/nco/ops/com/hsofs/test/"
export stormID=$1 #"al142018"
export stormCycle=$2 #"2018091112"
export outputDir=${platform}"/gpfs/hps3/nos/noscrub/polar/hsofs/"
export tmpDir=${platform}"/gpfs/hps3/nos/noscrub/tmp/hsofs/"
export pltCfgFile=${platform}"/gpfs/hps3/nos/noscrub/nwprod/hsofs-1.5.1/scripts/config.plot.hsofs.fulldomain.ini"

export ftpLogin="svinogradov@emcrzdm"
export ftpPath="/home/www/polar/estofs/hsofs/nco/"${stormID}"."${stormCycle}""
