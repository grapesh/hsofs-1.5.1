...
def run_post(argv):
    ...
    if doMaxWind:
        ...
        for e in ens:
            ...
            maxwvelFile = \
                    hsofsPath + 'hsofs.' + args.stormID + '.' + \
                    args.stormCycle + '.' + e + '.fields.maxwvel.nc'
            trackFile = \
                    hsofsPath + 'hsofs.' + args.stormID + '.' + \
                    args.stormCycle + '.' + e + '.surfaceforcing'
            ...
            titleStr = 'HSOFS experimental ' + args.stormID + \
                    '.' + args.stormCycle + '.' + e + ' MAX WIND SPEED, m/s '

            plotFile = args.outputDir + args.stormID +'.'+ \
                        args.stormCycle +'.'+ e +'.maxwvel.png'
            plot.maxwind (maxwvel, track, advTrk, grid, coast, pp, titleStr, plotFile)
            csdlpy.transfer.upload(plotFile, args.ftpLogin, args.ftpPath)
